...
```text
/xxd-panel-064 <source-or-directory> --mode top-bottom,design-only \
...
1. 上下对照（原图在上，064 设计在下）
2. 左右对照（原图在左，064 设计在右）
...
```text
~/Desktop/xxd/xxd-panel-064/<fresh-task>/
...
- `references/xxd-panel-064-prompt.zh-CN.md`
- `references/xxd-panel-064-prompt.en.md`
