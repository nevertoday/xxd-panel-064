...
# 🦁 XXD Panel 064｜صفحة كولاج مستقلة
...
عندما تحتاج الصور القديمة أو سجلات السفر أو الذكريات الشخصية إلى إحساس بمرور الزمن، فإن تطبيق مرشح قديم مباشرة لا يترك غالباً سوى اصفرار وتصنّع متعمد، من دون أن يوضح ما يستحق الاحتفاظ به. كما أن القصاصات التي تملأ الصفحة كلها تتحول بسهولة إلى دفتر مزدحم يفقد الهدوء والمسافة.

يفكك **Panel 064** أهم ما في الهوية والعلاقات والمشاعر إلى عدد قليل من قصاصات الورق القديم وخطوط خفيفة وشذرات نصية. تصنع الحواف الممزقة والأجزاء الناقصة والانزياح البسيط والمساحات الفارغة الواسعة إحساساً مقنعاً بأرشيف شخصي، بينما يقتصر دور لون أو لونين من الصورة الأصلية على استدعاء الذاكرة.

### استخدمه في هذه الحالات

- **عندما تحمل الصورة طابع الذاكرة أو الأرشيف:** تحتاج العائلة والسفر والشخصيات والأغراض القديمة والأماكن إلى إعادة تنظيم هادئة.
- **عندما تريد التعبير عن النقص من دون خسارة سهولة التعرّف:** تُحذف الصورة الكاملة والتفاصيل الثانوية فقط، بينما تبقى الهوية الأساسية والعلاقات واضحة.
- **عندما تحتاج إلى أثر الزمن من دون مرشح قديم مبتذل:** تكون ألوان الورق القديم الطبيعية والحواف الممزقة والخطوط الخفيفة وشذرات النص أكثر ضبطاً من الاصفرار الثقيل.
...
> استخدم XXD Panel 064 لهذه الصورة، واقترح أولاً أنسب تكوين ومقاس.
...
## تحقق سريع: هل XXD Panel 064 مناسب لك؟

| ما الذي يهمك؟ | ما الذي يقدمه هذا الأسلوب؟ |
|---|---|
| **النتيجة التي ستحصل عليها** | تحويل الصور إلى ملفات مجمعة ورقية قديمة هادئة وغير مكتملة ومليئة بالوقت |
| **السمات التي تُعرف من النظرة الأولى** | مجموعة من الورق القديم · حواف ممزقة يدويًا · إحساس أرشيفي · طباعة صغيرة على الآلة الكاتبة · مساحة فارغة شعرية |
...
إنه يقطر الهوية والعلاقات والعواطف التي تستحق الحفاظ عليها، ثم يعيد بنائها من بضع قطع من الورق الممزق، وعلامات القلم الرصاص والحبر، وبقايا النصوص. تخلق الحواف المكسورة والإزاحة الطفيفة والمناطق الفارغة الواسعة أرشيفًا خاصًا هادئًا وقابلاً للتصديق.

```text
قفل الهوية وجوهر السرد ← إزالة المشهد الكامل والتفاصيل الثانوية ← إعادة البناء باستخدام قطع الورق القديمة والرسم الضوئي وبقايا الأرشيف ← الحفاظ على الحواف الممزقة والإزاحة وعدم الاكتمال ← إلقاء الضوء بلون واحد أو اثنين من ألوان الذاكرة من المصدر ← وضع نسخة مجهرية من الآلة الكاتبة داخل الحقل الفارغ
```

## السمات التي تميّز الأسلوب النهائي

- تعمل مجموعة الورق القديمة والحواف الممزقة يدويًا والقلم الرصاص والحبر على إنشاء نسيج أرشيفي دقيق بدلاً من التأثير العتيق الثقيل.
- لا يتم إعادة رسم الموضوع بالكامل أبدًا؛ لم يتبق سوى ما يكفي من الشكل والعلاقة للاعتراف بها.
- يهيمن الورق والرمادي الفاتح والبني الفاتح والحبر القديم، بينما يظهر لون أو لونان من الألوان المصدرية كعلامات ذاكرة فقط.
- قد يتقلص الموضوع، أو يتحرك، أو يطفو، أو يتم اقتصاصه بحيث يمكن للمساحة الفارغة أن تحمل الوقت والصمت والمسافة.
- قد يتم تشغيل نسخة الآلة الكاتبة الصغيرة أفقيًا، أو رأسيًا، أو غير محكم، أو على طول الحافة، ويتم تأليفها معًا باستخدام الكولاج والمساحة.

توجد القيود الجمالية وقواعد الرفض فقط في [الموجّه الصيني الأصلي](references/original-prompt/zh-CN.md)، بينما يتولى الـ Skill ومهايئ التشغيل متغيرات التسليم فقط. [سير عمل Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-064-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 064. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-064 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-064 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-064 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-064 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 064 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-064 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-064`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-064-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-064-prompt.zh-CN.md)
...
| **[xxd-panel-064](https://github.com/nevertoday/xxd-panel-064)** | شكل أسود رئيسي · فراغ هائل · تلاشي هالف تون · تأمل زِنّي · شظايا فكر |
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–064) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
